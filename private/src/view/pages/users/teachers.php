            ...
            <div class="coluna-barra-lateral d-none d-sm-block bg-inscricao">
                <div class="container-fluid" id="BotoesBarraLateral">
                    ...
                    <button class="btn btn-verde w-100 mt-2">Ver dados das turmas</button>
                    <button class="btn btn-verde w-100 mt-2">Consultar frequência dos alunos</button>
                    <button class="btn btn-verde w-100 mt-2">Consultar notas dos simulados</button>
                    <button class="btn btn-verde w-100 mt-2">Consultar contato dos alunos</button>
                    <button class="btn btn-verde w-100 mt-2 mb-3">Consultar cronograma</button>
                </div>
