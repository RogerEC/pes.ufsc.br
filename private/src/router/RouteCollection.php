...
class RouteCollection
{
    ...
    protected function addPost($pattern, $callback){
        ...
        $this->routes_post[$this->definePattern($pattern)] = ['callback' => $callback, 'values' => $values, 'namespace' => $settings['namespace'] ?? null];
    ...
    protected function addGet($pattern, $callback){
        ...
        $this->routes_get[$this->definePattern($pattern)] = ['callback' => $callback, 'values' => $values, 'namespace' => $settings['namespace'] ?? null];
    ...
    protected function addPut($pattern, $callback){
        ...
        $this->routes_put[$this->definePattern($pattern)] = ['callback' => $callback, 'values' => $values, 'namespace' => $settings['namespace'] ?? null];
        if(isset($settings['as'])) {
            $this->route_names[$settings['as']] = $pattern;
        }
    ...
    protected function addDelete($pattern, $callback){
        ...
        $this->routes_delete[$this->definePattern($pattern)] = ['callback' => $callback, 'values' => $values, 'namespace' => $settings['namespace'] ?? null];
